...
encuesta_mrp <- readRDS("CRI/2022/encuesta_mrp.rds")
statelevel_predictors_df <- readRDS("CRI/2022/statelevel_predictors_df.rds")
...
censo <- readRDS("CRI/2022/censo_mrp.rds") |>
  mutate(
    region = recode(
      dam,
      "01" = "Central",
