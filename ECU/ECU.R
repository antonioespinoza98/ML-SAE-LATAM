...
censo <- readRDS("ECU/2022/censo_mrp.rds") 
...
# saveRDS(fhat_Test1, "ECU/output/prediction.rds")
...
f <- readRDS("ECU/output/prediction.rds")
length(f)
...
fit <- readRDS("ECU/output/fit.rds")
...
# saveRDS(PBS, "ECU/output/PBS.rds")
...
# saveRDS(PBS_long, "ECU/output/PBS_long.rds")
# saveRDS(mean_df, "ECU/output/mean_df.rds")
...
# saveRDS(final, "ECU/output/bootstrap_results.rds")

final <- readRDS("ECU/output/bootstrap_results.rds")
...
ggsave(boot, filename= "ECU/output/boot.jpg")
# Mapas -------------------------------------------------------------------
rm(list = ls())
